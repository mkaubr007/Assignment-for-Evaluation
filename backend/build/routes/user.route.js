...
class UserRoutes {
    constructor() {
        ...
        this.routes = () => {
            ...
            this.router.post('/register', this.UserValidator.newUser, this.UserController.newUser);
            //route to login user
            this.router.post('/login', this.UserValidator.loginUser, this.UserController.login);
